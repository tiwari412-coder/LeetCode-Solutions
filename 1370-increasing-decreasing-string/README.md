<h2><a href="https://leetcode.com/problems/increasing-decreasing-string/description/">1472. Increasing Decreasing String</a></h2><h3>Easy</h3><hr><p>You are given a string <code>s</code>. Reorder the string using the following algorithm:</p>
